...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(cursor ((,class (:background "#f0dc82")))) ;; #656565
   ;; Highlighting faces
   ...
   `(minibuffer-prompt ((,class (:foreground "#ed9121")))) ; #e5786d
   ...
   `(font-lock-keyword-face ((,class (:foreground "#54aff2" :weight bold)))) ;"#8ac6f2"
   `(font-lock-string-face ((,class (:foreground "#95e454"))))
   `(font-lock-type-face ((,class (:foreground "#199696" :weight bold)))) ;"#92a65e"
